...
<div class="login-box">
  ...
  <div class="login-box-body" style="border:2px solid #226bbf;">
    <div class="row">
      ...
      <p class="login-logo"><b>PERPUSTAKAAN</b><br>FAKULTAS TEKNIK</p>
    </div>
    <p class="login-box-msg" style="font-size:16px;"></p>
    <?= $this->session->flashdata('message'); ?>
    <form action="<?= base_url('login/auth');?>" method="POST">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="NIM" id="user" name="user" required="required" autocomplete="off">
      ...
      <div class="row">
        <div class="col-xs-6">
          ...
          <a href="<?= base_url('login/daftar') ?>" id="loding" class="btn btn-block btn-flat">Daftar</a>
