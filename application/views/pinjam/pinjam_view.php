	    ...
	    <div class="col-md-12">
	        <div class="box box-primary">
                <div class="box-header with-border">
					...
					<?php }else{ ?>
						<a href="<?= base_url('transaksi/cetak_book_certificate') ?>"><button class="btn btn-primary">
						<i class="fa fa-print" style="margin-right: 5px;"></i> Cetak Bukti Bebas Pinjam</button></a>
					<?php } ?>
